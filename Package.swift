...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBAcneEyebagsRemoval",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.9.3-95-g54f78c5d8b/BNBAcneEyebagsRemoval.zip",
            checksum: "eaca7eb79f6c30eee570da6fc0db290ccb1f4835dbdc35e4eb1a70a8a14629bc"
        ),
        .target(
