...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBAcneEyebagsRemoval",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-147-gb1b24af02/BNBAcneEyebagsRemoval.zip",
            checksum: "2323ae8149f4c78aadedf21d13b8925dc8012db5a8f8a9bc08d8ea5cbefebbdd"
        ),
        .target(
