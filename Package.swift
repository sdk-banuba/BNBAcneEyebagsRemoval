...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBAcneEyebagsRemoval",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-130-g1d6e43380/BNBAcneEyebagsRemoval.zip",
            checksum: "f7318f02e435095cb92a532204810324760b02518397320072867a141013e6c1"
        ),
        .target(
