...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBAcneEyebagsRemoval",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-211-g9b253c9f0f/BNBAcneEyebagsRemoval.zip",
            checksum: "f32fe7410320be3f3e3ffbd48756ef63b87ecfd79dd76725ab51143d8e6f344d"
        ),
        .target(
