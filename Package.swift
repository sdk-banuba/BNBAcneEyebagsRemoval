...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBAcneEyebagsRemoval",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.17.0-66-g886631a577/BNBAcneEyebagsRemoval.zip",
            checksum: "61af72ffe0ef6b82e37c769f87ed0399aef8f1a0931edda04e28eab3e20fb075"
        ),
        .target(
