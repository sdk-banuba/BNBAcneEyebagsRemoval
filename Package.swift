...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBAcneEyebagsRemoval",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.12.1-33-g6de24312a/BNBAcneEyebagsRemoval.zip",
            checksum: "39ae6000f0b1c1c7ed49496c4bcf8dec6f07d6bb181009f9f078f01af1407ba5"
        ),
        .target(
