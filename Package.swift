...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBAcneEyebagsRemoval",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-105-gb559f9611/BNBAcneEyebagsRemoval.zip",
            checksum: "9106717ef84a6284fda968d41fecbe719f555bf2fb9484fdd1de1f65dd322753"
        ),
        .target(
