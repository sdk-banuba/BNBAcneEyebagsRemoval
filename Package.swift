...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBAcneEyebagsRemoval",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-143-g50b5f987b/BNBAcneEyebagsRemoval.zip",
            checksum: "750fd2d2700508fb665caecac9978c883d7c150eba649fc77f593170b6852b55"
        ),
        .target(
