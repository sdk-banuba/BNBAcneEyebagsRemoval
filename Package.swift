...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBAcneEyebagsRemoval",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-183-gf9e3d7354f/BNBAcneEyebagsRemoval.zip",
            checksum: "2823face01abeed4fb2f2f83a7e4f9820b35a3e6420851fe5093c9d8f2138637"
        ),
        .target(
