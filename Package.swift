...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBAcneEyebagsRemoval",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-175-g35e1b614c0/BNBAcneEyebagsRemoval.zip",
            checksum: "305a2590d2743f39e16e3aa61714b6cef699ef686c9feb33f8455d4bad03f0cb"
        ),
        .target(
