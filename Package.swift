...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBAcneEyebagsRemoval",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-187-g0f5dcf5d80/BNBAcneEyebagsRemoval.zip",
            checksum: "ca6ed86fecd5879f490edb6400f2440f910bace9ba40fd2cd1625cc48e988ce5"
        ),
        .target(
