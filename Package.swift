...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBAcneEyebagsRemoval",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.10.1-73-g8d138045c3/BNBAcneEyebagsRemoval.zip",
            checksum: "6ad34835f7859dfe088d54f1af2d6ec9d650fc4a9d9ef8541a6b3aa5545815c9"
        ),
        .target(
