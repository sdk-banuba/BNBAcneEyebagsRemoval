...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBAcneEyebagsRemoval",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.18.0-8-g22fe376040/BNBAcneEyebagsRemoval.zip",
            checksum: "55b99206c555ca0011c9dfd2d1d82bbfd2e5e2fff1c9491b41250d831863642d"
        ),
        .target(
