...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBAcneEyebagsRemoval",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.11.1-70-g9f1f1a3b1/BNBAcneEyebagsRemoval.zip",
            checksum: "dce9dda60aa0fff1c067519c86b48d974094d89016f30023598067b64eba8629"
        ),
        .target(
