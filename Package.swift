...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBAcneEyebagsRemoval",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-203-g2a72d3010f/BNBAcneEyebagsRemoval.zip",
            checksum: "9cb7aa8e7b7cd15cdcf0d96ad3b21ef7406f38827ae0d1ce6d64bb69bc5591e8"
        ),
        .target(
