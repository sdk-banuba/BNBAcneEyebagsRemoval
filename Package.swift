...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBAcneEyebagsRemoval",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-53-g189d46433/BNBAcneEyebagsRemoval.zip",
            checksum: "0b58d41c6e44dc519c90ea04bc3bffdf1a3976017eba278582f6e6b1f1d8003d"
        ),
        .target(
