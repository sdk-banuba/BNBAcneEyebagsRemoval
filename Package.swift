...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBAcneEyebagsRemoval",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-61-gc1c7cef54/BNBAcneEyebagsRemoval.zip",
            checksum: "acf3bdca1a725dccb2ccbe869e231bcd7b96cb068f3e67b0d75a7ecb7fdea8d9"
        ),
        .target(
