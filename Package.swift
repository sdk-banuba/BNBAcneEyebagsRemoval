...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBAcneEyebagsRemoval",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.3-43-gc75a0b291/BNBAcneEyebagsRemoval.zip",
            checksum: "42d06f429821146cf1d110694af1262b951e18c5ceabaa507d73882489b54df9"
        ),
        .target(
