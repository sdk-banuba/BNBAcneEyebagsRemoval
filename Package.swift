...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBAcneEyebagsRemoval",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-218-g91528edbf1/BNBAcneEyebagsRemoval.zip",
            checksum: "a21bcbb2f1b5afdf3ae77f1e6553a54d8f84962d436e2b051f469384b405e65d"
        ),
        .target(
