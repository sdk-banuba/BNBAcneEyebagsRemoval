...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBAcneEyebagsRemoval",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-217-g36d3a95c51/BNBAcneEyebagsRemoval.zip",
            checksum: "19564419530e0de459065ebd32f801c10c7422250f638735b7008d9e245831e1"
        ),
        .target(
