...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBAcneEyebagsRemoval",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-173-gec24d1c86/BNBAcneEyebagsRemoval.zip",
            checksum: "c59c9366125daf145bb66b96c0176940d03593c54c183e1819fc76160220d07e"
        ),
        .target(
