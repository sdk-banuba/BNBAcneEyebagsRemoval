...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBAcneEyebagsRemoval",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.15.1-1-g11945c35fb/BNBAcneEyebagsRemoval.zip",
            checksum: "3794bfc3beb17f976dc9c26edff466e2feced31289657985d83e5d4cf96e95e1"
        ),
        .target(
