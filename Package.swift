...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBAcneEyebagsRemoval",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.11.1-38-g9a4283c65/BNBAcneEyebagsRemoval.zip",
            checksum: "458205822e01aed47f0aa7e744bd49576d98f826dede876b159ad50d216ed915"
        ),
        .target(
