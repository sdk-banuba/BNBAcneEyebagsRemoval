...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBAcneEyebagsRemoval",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.11.1-1-ge047381c9/BNBAcneEyebagsRemoval.zip",
            checksum: "7c37006f8f794a29972dbe5328c8977df2fecc2f190edcf99a4f97cd44845098"
        ),
        .target(
