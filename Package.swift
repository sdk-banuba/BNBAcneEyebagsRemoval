...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBAcneEyebagsRemoval",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-138-g40eb4c9af/BNBAcneEyebagsRemoval.zip",
            checksum: "a8f54b0dec935a968728464c09db6bbcc858d2f26c5bf7431eba95833fe138cd"
        ),
        .target(
