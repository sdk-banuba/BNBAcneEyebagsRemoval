...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBAcneEyebagsRemoval",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-74-g9d1b0a47e/BNBAcneEyebagsRemoval.zip",
            checksum: "e34c17f34de5fcf21b8444bde4232a84962f243a600e04556b5407279cb906e5"
        ),
        .target(
