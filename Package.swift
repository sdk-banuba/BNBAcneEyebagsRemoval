...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBAcneEyebagsRemoval",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-170-g93323bc96/BNBAcneEyebagsRemoval.zip",
            checksum: "dfce7f764d702445018e6b10e95e11cbe5b5c2db3bd7254ec2056c673e296c26"
        ),
        .target(
