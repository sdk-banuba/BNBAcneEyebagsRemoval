...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBAcneEyebagsRemoval",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-55-g4d630007f/BNBAcneEyebagsRemoval.zip",
            checksum: "2c8b1278fd2b7cd78ed690632e492483d82bd99f495a315b58ca5fc5af5f5c21"
        ),
        .target(
