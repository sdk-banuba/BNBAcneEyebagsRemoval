...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBAcneEyebagsRemoval",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-150-gd7caecfaf/BNBAcneEyebagsRemoval.zip",
            checksum: "fd3344c78320da136252cbb9b6279a8c2bb8bce8b7a49363a561bb0bf8e3ec77"
        ),
        .target(
