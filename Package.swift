...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBAcneEyebagsRemoval",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.9.1-86-g65c1c833d4/BNBAcneEyebagsRemoval.zip",
            checksum: "42d8a50769bcaa4cde0ab41d89c79e5e385cb20de784f1a30da19a8cffe16a67"
        ),
        .target(
