...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBAcneEyebagsRemoval",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-106-g81956e5c7/BNBAcneEyebagsRemoval.zip",
            checksum: "376c2d2ec6cf6f041d28663edcb646377b334cd9c22f2cf291adc8de6c887dc9"
        ),
        .target(
