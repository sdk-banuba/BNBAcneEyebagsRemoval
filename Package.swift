...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBAcneEyebagsRemoval",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-203-g079acbf0ae/BNBAcneEyebagsRemoval.zip",
            checksum: "0af1f2bb6b75a67e55269cc3b8a5642347db1723cb314a2933957b5a0fda4234"
        ),
        .target(
