...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBAcneEyebagsRemoval",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-186-g71865c20be/BNBAcneEyebagsRemoval.zip",
            checksum: "43f524717aef4676d8d0663dd72021ff99d7b748c3c46288f2275e0b9660c4af"
        ),
        .target(
