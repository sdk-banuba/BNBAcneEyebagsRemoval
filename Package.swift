...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBAcneEyebagsRemoval",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.12.1-35-g200bb3db4/BNBAcneEyebagsRemoval.zip",
            checksum: "8d3ce5f142621c19fe9ba0dff0315eeaaa6b548740c431cfa2f2d1aad5e90d04"
        ),
        .target(
