...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBAcneEyebagsRemoval",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-184-gd8cb662170/BNBAcneEyebagsRemoval.zip",
            checksum: "8251d10f95a57bb87dde452a71c3f9e25ea2029dbfd78bd3557180295ee91edc"
        ),
        .target(
