...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBAcneEyebagsRemoval",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-146-g6f441498b/BNBAcneEyebagsRemoval.zip",
            checksum: "4ad88a8759b0b24ceb45d218830720c25884efbeac057641d07336dcc20251d2"
        ),
        .target(
