...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBAcneEyebagsRemoval",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-188-g3e9bf00b67/BNBAcneEyebagsRemoval.zip",
            checksum: "bcca5b1833a2339518a9d2690f32d8d6328959e40573e689d93858e369359efd"
        ),
        .target(
