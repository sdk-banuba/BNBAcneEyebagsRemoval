...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBAcneEyebagsRemoval",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-173-gee6f2723a/BNBAcneEyebagsRemoval.zip",
            checksum: "fc79b2703902edfd1a67536e13aa21be299fdb19e7a09f30a19b0d29ce146cc3"
        ),
        .target(
