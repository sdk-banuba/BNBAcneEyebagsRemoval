...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBAcneEyebagsRemoval",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.11.1-70-g2e0f1ab74/BNBAcneEyebagsRemoval.zip",
            checksum: "e87a409d776460343e5c4d4c992b7763fe19fccac96b0249ddde53a1a65c8ad8"
        ),
        .target(
