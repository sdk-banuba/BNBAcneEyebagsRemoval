...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBAcneEyebagsRemoval",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.10.0-19-gb88228b6f/BNBAcneEyebagsRemoval.zip",
            checksum: "fbee091a7a0a49f314033ea8bdd39f817fc9b108920e48b2d273d70032780e63"
        ),
        .target(
