...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBAcneEyebagsRemoval",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.12.1-40-gb99e5d381/BNBAcneEyebagsRemoval.zip",
            checksum: "50355cb0cad999b2618e6779e7bae839d6478caea8708b1a22d8dbc430f3042a"
        ),
        .target(
