...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBAcneEyebagsRemoval",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.9.4-99-gef5d08583/BNBAcneEyebagsRemoval.zip",
            checksum: "9d487a866d6c09bec8be23213971362142abcd21655e7549180238533cec97a9"
        ),
        .target(
