...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBAcneEyebagsRemoval",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-174-gec051bdc7/BNBAcneEyebagsRemoval.zip",
            checksum: "afaed59ded85a1ab126813b55462b31bddabbaaae9dfd543abfbd3ee98510a3a"
        ),
        .target(
