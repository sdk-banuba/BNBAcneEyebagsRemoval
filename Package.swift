...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBAcneEyebagsRemoval",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-136-g6ec65980f/BNBAcneEyebagsRemoval.zip",
            checksum: "7c79964dc4029c66fb6b40d6fa44f98eb2da9d0dcf40776f54234fe9aa9f650c"
        ),
        .target(
