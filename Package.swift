...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBAcneEyebagsRemoval",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-185-gcf256de1ef/BNBAcneEyebagsRemoval.zip",
            checksum: "c135ba4e20e106444db6e612ef8adbe3f4079d2f5b3f8abc2c54c13f2d9ee7fe"
        ),
        .target(
