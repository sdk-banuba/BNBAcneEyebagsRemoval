...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBAcneEyebagsRemoval",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.11.1-71-g826381c83/BNBAcneEyebagsRemoval.zip",
            checksum: "abff1b2bed6649775276d8c262fd0f14dfb8e046056e5b555d9cb0af15393825"
        ),
        .target(
