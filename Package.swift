...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBAcneEyebagsRemoval",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-180-gd5fc258816/BNBAcneEyebagsRemoval.zip",
            checksum: "aaa52293828251cd94d09e750408eb363a9e60043411b8aa72ef1f11c4a8e3df"
        ),
        .target(
