...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBAcneEyebagsRemoval",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-194-gb1629e3e8c/BNBAcneEyebagsRemoval.zip",
            checksum: "1da4fd25098e40ea8594bc369695ae87c0acdaf05f1363af2d7a0e5877016cc2"
        ),
        .target(
