...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBAcneEyebagsRemoval",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-4-g0bf2ba10e/BNBAcneEyebagsRemoval.zip",
            checksum: "c174ddc33b54134abd48f9a8d91894d0dd4098e7b2d65b1285450d8b8a584f3a"
        ),
        .target(
