...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBAcneEyebagsRemoval",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-137-gc11b2b754/BNBAcneEyebagsRemoval.zip",
            checksum: "c462d7bd67083550b479dae8d20e9a357078dce3ed9b3caa7ed85232f648d248"
        ),
        .target(
