...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBAcneEyebagsRemoval",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-215-g9f21b13b23/BNBAcneEyebagsRemoval.zip",
            checksum: "45eb44b5523eff24e897aaeb286337dfceee94fe1d0f6f1da7fbd3d7ff71e01d"
        ),
        .target(
