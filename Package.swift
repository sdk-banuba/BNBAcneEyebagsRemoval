...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBAcneEyebagsRemoval",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-124-gbdb47c5e3/BNBAcneEyebagsRemoval.zip",
            checksum: "dca46b93045b6a48ff98ebeb8880321d243ee3a16ea5c37d15543676eaec42ef"
        ),
        .target(
