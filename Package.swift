...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBAcneEyebagsRemoval",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-185-gf41e807277/BNBAcneEyebagsRemoval.zip",
            checksum: "36a6046ff4519abe7dd70ad9d45bb6ddd7fba59535e65a8bbcfb472357a713ab"
        ),
        .target(
