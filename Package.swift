...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBAcneEyebagsRemoval",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.9.1-69-g431d04ab4a/BNBAcneEyebagsRemoval.zip",
            checksum: "3a6c719bd309bd1f35be59697755ef27745cc70c38f59fb790f0914f3b3b8123"
        ),
        .target(
