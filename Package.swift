...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBAcneEyebagsRemoval",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.0-9-g9cd2ba648/BNBAcneEyebagsRemoval.zip",
            checksum: "25150846c07cdf2d5230291031e0f658483c8184f8dfa262d8947add7da26369"
        ),
        .target(
