...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBAcneEyebagsRemoval",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-68-g8184560bc/BNBAcneEyebagsRemoval.zip",
            checksum: "931d9c4517a11a9a32b4326a311b39b5417f2fccc6835957ffae5c4264358e37"
        ),
        .target(
