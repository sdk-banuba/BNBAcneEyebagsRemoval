...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBAcneEyebagsRemoval",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-184-gfc3672a53b/BNBAcneEyebagsRemoval.zip",
            checksum: "2ceefb29e6027f0a28befde1ed36a0fd21da6655bbc2eaa048d7011d53b4c8e3"
        ),
        .target(
